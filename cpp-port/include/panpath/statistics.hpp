...
struct EditCounts {
    std::uint64_t matched = 0, substituted = 0, source_only = 0, graph_only = 0, ambiguous_columns = 0;
...
Alignment align(std::span<const std::uint8_t> source, std::span<const std::uint8_t> graph,
